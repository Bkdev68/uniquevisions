...
export const Hero = () => {
  ...
  return <section className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-background">
      ...
      <div className="container mx-auto px-4 lg:px-8 pt-32 pb-16 relative z-10">
        ...
        delay: 0.8
          ...
          <Button onClick={scrollToServices} size="lg" className="bg-foreground/10 hover:bg-foreground/20 text-foreground border border-border backdrop-blur-sm px-8 py-6 text-base font-medium rounded-md transition-all">
